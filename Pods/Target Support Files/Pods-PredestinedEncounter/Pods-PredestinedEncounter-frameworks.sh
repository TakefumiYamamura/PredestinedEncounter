...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-PredestinedEncounter/FacebookSDK.framework"
  ...
  install_framework "Pods-PredestinedEncounter/Parse.framework"
  install_framework "Pods-PredestinedEncounter/ParseFacebookUtils.framework"
